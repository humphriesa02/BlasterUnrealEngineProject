...
ABlasterCharacter::ABlasterCharacter()
{
	...
	// Defaults for update frequency in online replication
...
/// <summary>
/// Handles when a player gets eliminated for each client
/// </summary>
void ABlasterCharacter::MulticastElim_Implementation()
{
	...
	*/
	...
	// Stop WASD from moving the player
	GetCharacterMovement()->DisableMovement();
	// Stop rotation of the player from moving the mouse
	...
	// If eliminated while aiming with sniper rifle
...
void ABlasterCharacter::BeginPlay()
{
	...
	// Ensure if a character spawns during cooldown, they cannot use inputs
	ABlasterGameMode* BlasterGameMode = Cast<ABlasterGameMode>(UGameplayStatics::GetGameMode(this));
...
/// <summary>
/// Plays the fire montage when firing a weapon
/// </summary>
/// <param name="bAiming">Whether we are aiming while firing or not</param>
...
void ABlasterCharacter::PlayThrowGrenadeMontage()
{
	...
	{
		float TimeRemaining = AnimInstance->Montage_Play(ThrowGrenadeMontage);
	}
}
...
void ABlasterCharacter::UpdateHUDWeaponType()
{
	...
	if (BlasterPlayerController && Combat && Combat->EquippedWeapon)
	{
		BlasterPlayerController->SetHUDWeaponType(Combat->EquippedWeapon->GetWeaponType(), true);
	}
}
